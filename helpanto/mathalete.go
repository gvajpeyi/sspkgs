...
var  CommaNoDecimalRounded string = "#,###."
var  CommaThreeDecimalPlaces string = "#,###.###"
// PercentageDiff calculates the percentage difference from float a to float b.
// If a > b the returned value will be negative
// If b > a the returned value will be positive
// If a == b  then zero is returned
func PercentageDiff(a, b float64) float64{
	...
	//diff, _ = strconv.ParseFloat(diffStr, 64)
