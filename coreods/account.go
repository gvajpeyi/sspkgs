...
// DevAcct represents a Core device number (computer number) with it's associated Account number (customer number)
// CustomerNumber and ComputerNumber are the field names used in the server table of Core_ODS DB
type DevAcct struct {
